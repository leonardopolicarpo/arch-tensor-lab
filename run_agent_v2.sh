...
echo "${AZUL}---------------------------------------------------${RESET}"
echo "  ${NEGRITO}${VERMELHO}Arch-Tensor-Lab: Motor Agent V2 (Char)${RESET}"
echo "${AZUL}---------------------------------------------------${RESET}"
echo ""
...
echo "Modelo  : ${AZUL}agent_v2_weights.pt${RESET}"
...
python main.py -f "chat_pro.txt" -t "agent_v2.pt" -m "agent_v2" $TRAIN_FLAG $STEPS_FLAG